...
const messages: Record<Locale, Messages> = {
  "en-US": {
    ...
    "newTransaction.helpAmount":
      "Use the absolute value. SpendWise applies the sign based on income or expense.",
  ...
  "pt-BR": {
    ...
    "dashboard.addFirstMonthly":
      "Adicione sua primeira receita ou despesa para ver o saldo mensal.",
    "dashboard.positiveMonth": "Seu mês está positivo.",
    "dashboard.expensesHigher":
      "As despesas estão maiores que as receitas neste mês.",
    ...
    "newTransaction.helpAmount":
      "Use o valor absoluto. O SpendWise aplica o sinal com base em receita ou despesa.",
    "newTransaction.helpType":
      "Despesa reduz seu saldo. Receita aumenta seu saldo.",
    "newTransaction.helpCategory":
    ...
    "categories.subtitle":
      "Organize suas transações com categorias de receita e despesa.",
    ...
    "categories.newSubtitle": "Crie uma categoria para receitas ou despesas.",
