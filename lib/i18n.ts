...
const messages: Record<Locale, Messages> = {
  "en-US": {
    ...
    "common.transactionCreated": "Transaction created successfully.",
    "common.id": "ID",
    "category.food": "Food",
    ...
    "transactions.filterCategory": "Category",
    ...
    "currencyConverter.section": "Exchange",
    "currencyConverter.title": "Currency converter",
    "currencyConverter.subtitle": "Convert dollars and reais with the latest available market quote.",
    "currencyConverter.from": "From",
    "currencyConverter.to": "To",
    "currencyConverter.amount": "Amount",
    "currencyConverter.swap": "Swap currencies",
    "currencyConverter.convert": "Convert amount",
    "currencyConverter.converting": "Converting...",
    "currencyConverter.result": "Converted value",
    "currencyConverter.invalidAmount": "Enter a valid amount greater than zero.",
    "currencyConverter.maxAmount": "Amount cannot exceed 10,000,000.",
    "currencyConverter.serviceError": "The exchange rate is unavailable right now. Try again shortly.",
    "currencyConverter.updatedAt": "Updated {date}",
  ...
  "pt-BR": {
    ...
    "common.transactionCreated": "Transação criada com sucesso.",
    "common.id": "ID",
    ...
    "transactions.filterType": "Tipo",
    "transactions.filterCategory": "Categoria",
    ...
    "currencyConverter.section": "Câmbio",
    "currencyConverter.title": "Conversor de moedas",
    "currencyConverter.subtitle": "Converta dólares e reais com a cotação de mercado mais recente disponível.",
    "currencyConverter.from": "De",
    "currencyConverter.to": "Para",
    "currencyConverter.amount": "Valor",
    "currencyConverter.swap": "Inverter moedas",
    "currencyConverter.convert": "Converter valor",
    "currencyConverter.converting": "Convertendo...",
    "currencyConverter.result": "Valor convertido",
    "currencyConverter.invalidAmount": "Insira um valor válido maior que zero.",
    "currencyConverter.maxAmount": "O valor não pode ultrapassar 10.000.000.",
    "currencyConverter.serviceError": "A cotação está indisponível agora. Tente novamente em instantes.",
    "currencyConverter.updatedAt": "Atualizado em {date}",
